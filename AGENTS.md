...
| 2026-04-26 | 브라우저 확장 프로그램 고도화: 이미지 우클릭 "VibeRef에 저장" 컨텍스트 메뉴 추가 |
| 2026-04-26 | 이미지 URL 직접 입력 로직 최적화: 캡처 및 업로드 없이 즉시 저장되도록 수정 |
| 2026-04-26 | 브라우저 확장 안정성 개선: background 리로드 로직 보강 및 popup 메시지 리스너 추가 |
| 2026-04-26 | 브라우저 확장 UX 개선: 우클릭 저장 시 팝업 자동 오픈 및 데이터 복구 로직 강화 |
